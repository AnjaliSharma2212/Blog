...
const filteredUsers= users.filter(user=> user.courses.filter(course=> course.completed && course.rating>4).length>=2)
console.log(filteredUsers.map(u=>({id: u.id,name: u.name})))